...
- riemann_sparse       : Recuperación espectral sparse (Fases #261–#264)
- riemann_sparse_recovery: Hamiltoniano Berry-Keating sparse
- convergence_proof    : Censura taquiónica y prueba de convergencia
- upe_validation       : Validación experimental UPE (Emisiones Fotónicas Ultra-Débiles)
